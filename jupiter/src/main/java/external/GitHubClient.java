...
public class GitHubClient {
	...
	// Search jobs based on location and keywords from GitHub Jobs API.
	public List<Item> search(double lat, double lon, String keyword) {
		// Determine the URL. lat, lon and keywords are all from front-end.
		if (keyword == null) {
		...
		// If has CPE or IOE, return an empty list.
		return new ArrayList<>();
	}
	// Get item list from JSONArray.
	...
	// If obj does not exist return and empty string.
