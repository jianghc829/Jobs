...
public class MonkeyLearnClient {
	private static final String API_KEY = "3a6e9bc28cab83a2a2d459bf0e6d792db94e80dd";
       public static void main(String[] args) {
		
		String[] textList = {
			"Elon Musk has shared a photo of the spacesuit designed by SpaceX. "
			+ "This is the second image shared of the new design and the first to feature the spacesuit’s full-body look."};
